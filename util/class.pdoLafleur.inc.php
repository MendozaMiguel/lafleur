...
*/
	public function creerCommande($nom,$rue,$cp,$ville,$mail, $lesIdProduit,$lesQuantite )
	{
	...
	//public function admin($login,$mdp)
	//$req="select nom,mdp from administrateur where nom=$login and mdp=$mdp";
	//$res = PdoLafleur::$monPdo->query($req);
